...
(define (adjoin-set x set)
  (if (not (element-of-set? x set))
    (append set (list x)) ; I like append more than cons here. cons is more efficient, though.
    set)); just return set
...
; We could define same abstractions for the sets which are ordered.
...
; (output (element-of-set? 5 (list 1 2 3 4 5 6)))
...
; (output (intersection-set (list 1 2 3 4) (list 3 4 5 6)))
